...
neuron2 = Excitatory_Neuron(res, 2, 1)
neuron2.set_weights([15,15])

neuron3 = Excitatory_Neuron(res, 2, 1)
neuron3.set_weights([15,15])

neuron4 = Excitatory_Neuron(res, 2, 1)
...
while k < sim_time:
    ...
    # Set inputs for xor gate (neurons 1 and 2)
    neuron1.inputs[0] = inputs[k][0]
    neuron1.inputs[1] = inputs[k][1]
    neuron2.inputs[0] = inputs[k][0]
