...
if __name__ == '__main__':
    ...
    while True:
        ...
        if( motiontime >= 0):
            ...
            print("state : ",state.motorState[d['FR_0']].q)
            print("state : ",state.motorState[d['FR_1']].q)
            print("state : ",state.motorState[d['FR_2']].q)
# 
            print(f"θ_hip: {qDes[0]} radians")
            print(f"θ_thigh: {qDes[1]} radians")
            print(f"θ_calf: {qDes[2]} radians")

            e0=state.motorState[d['FR_0']].q - qDes[0]
            e1=state.motorState[d['FR_1']].q - qDes[1]
            e2=state.motorState[d['FR_2']].q - qDes[2]
            ...
            if( motiontime >= 10 and motiontime < 400):
                ...
                print(qInit)                   # needs count to 200
                Kp = [5, 5, 5]
                Kd = [1, 1, 1]
                # Kp = [20, 20, 20]
                # Kd = [2, 2, 2]
            ...
            t = dt*sin_count
            if( motiontime >= 400 and motiontime < 3000):
                sin_count += 1
                # sin_joint1 = 0.6 * sin(3*M_PI*sin_count/1000.0)
                # sin_joint2 = -0.9 * sin(3*M_PI*sin_count/1000.0)
                sin_joint0 = 0.5 * math.sin(t*freq_rad)
