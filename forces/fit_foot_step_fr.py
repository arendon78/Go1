...
coordinates_considered  = fr_coordinates # Tried to change the foot considered to see if pattern matching would work  : it doesn't work. 
...
find_patterns(merged_mins_maxes_coordinates,coordinates_considered,400, 400, 4)
...
axs[0].plot(times, [coordinates_considered[i][1] for i in range (len(coordinates_considered))], label='FR', marker='o')
