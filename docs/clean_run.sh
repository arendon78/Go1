...
python generate_docs.py ../src/animation/manim_env ../src/animation/media/ ../src/animation/datas ../src/forces/datas/ ../src/forces/experiments ../src/Neuroscience/tests ../src/unitree_legged_sdk/build/ ../src/unitree_legged_sdk/example/ ../src/unitree_legged_sdk/include/ ../src/unitree_legged_sdk/lib/ ../src/unitree_legged_sdk/example_py/Bezier/deprecated/ ../src/animation/ #à remettre à la fin, à faire en dernier car prend beaucoup de temps.
